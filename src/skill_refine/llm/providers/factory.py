"""Provider factory for the optional LLM layer."""
...
def get_provider(name: str, **kwargs: object) -> BaseProvider:
    ...
    if not provider.is_available():
        ...
        raise RuntimeError(f"Provider '{name}' is not available. {hint}")
...
def _register_builtins() -> None:
    from skill_refine.llm.providers.anthropic import AnthropicProvider
    from skill_refine.llm.providers.ollama import OllamaProvider
    from skill_refine.llm.providers.stub import StubProvider
